...
void edfstop(Proc *);
void edfyield(void);
int elf64ldseg(Chan *c, uintptr *entryp, Ldseg **rp, char *mach, u32 minpgsz);
int emptystr(char *);
...
void mmuswitch(Proc *);
Chan *mntattachversion(char *muxattach, char *version, u8 tag, Chan *(*mntchan)(void));
...
void *vmemalloc(VMemArena *arena, usize size, int flag);
VMemArena *vmemcreate(char *, u64, usize, usize);
void vmemdump(void);
usize vmemfreesize(VMemArena *arena);
Proc *wakeup(Rendez *);
